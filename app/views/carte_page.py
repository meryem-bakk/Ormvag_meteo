...
class CartePage(QWidget):
    ...
    def _build_ui(self):
        ...
        bouton_refresh = QPushButton("🔄 Rafraîchir les données")
        bouton_refresh.clicked.connect(self.actualiser_carte)

        entete.addWidget(titre)
        entete.addStretch()
        entete.addWidget(bouton_refresh)
    ...
    def actualiser_carte(self, station=None):
        html = self._generer_html_carte()
        self.vue_web.setHtml(html, baseUrl=QUrl("https://ormvag.local/"))
    ...
    def _generer_html_carte(self):
        ...
        if stations:
            ...
            centre_lat, centre_lon = 34.26, -6.58  # Kénitra par défaut
